import{x as i}from"./iframe-DM-4hbok.js";import{u as z,g as n,c as v,s as f,a as y,e as w,b as R,r as A,n as C,o as l,l as q,f as c}from"./style-Bf5CP6Wn.js";const m=e=>{e.style.height="",e.style.height=`${e.scrollHeight}px`},S=(e,o=0)=>{if(o>0){const s=e.getAttribute("rows")??"",t=e.style.height;e.style.height="",e.setAttribute("rows",o),e.style.maxHeight=e.getBoundingClientRect().height+"px",e.style.height=t,e.setAttribute("rows",s)}},E=e=>{const{value:o,maxRows:s}=e,t=z(()=>()=>e.shadowRoot.querySelector("#input"),[]);n(()=>S(t(),s),[s,t]),n(()=>m(t()),[t,o]),n(()=>{const a=t(),r=new ResizeObserver(()=>requestAnimationFrame(()=>m(a)));return r.observe(a),()=>r.unobserve(a)},[t])},I=["rows","placeholder",...y],M=e=>{const{autocomplete:o,value:s,placeholder:t,readonly:a,disabled:r,rows:p,cols:g,maxlength:h}=e,{onChange:x,onFocus:u,onInput:b,onRef:$}=R(e);return E(e),A(i`
			<textarea id="input" part="input"
				...
				.value=${q(s??"")} maxlength=${l(h)} @input=${b}
