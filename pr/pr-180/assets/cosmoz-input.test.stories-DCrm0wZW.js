import{b as s}from"./iframe-Dva1N4O_.js";import"./cosmoz-input-BgKBF6nH.js";import{s as c}from"./style-B25iUjjS.js";import"./preload-helper-PPVm8Dsz.js";import"./use-input-C1HRFeVg.js";const{expect:a,fn:v,waitFor:h}=__STORYBOOK_MODULE_TEST__,b={title:"Tests/Input"},r={render:()=>s`
        ${c}
        <cosmoz-input></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const n=o.querySelector("cosmoz-input");await t("focus() triggers focused-changed",async()=>{const e=v();n.addEventListener("focused-changed",e,{once:!0}),a(e).not.toHaveBeenCalled(),n.focus(),await h(()=>{a(e).toHaveBeenCalledTimes(1)})})}},u={render:()=>s`
        ${c}
        <cosmoz-input></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const n=o.querySelector("cosmoz-input");await t("change event is re-dispatched on the host",async()=>{const e=v();n.addEventListener("change",e);const w=n.shadowRoot.querySelector("input");w.focus(),w.value="hello",w.dispatchEvent(new Event("change",{bubbles:!0})),await h(()=>{a(e).toHaveBeenCalledTimes(1)})})}},l={render:()=>s`
        ${c}
        <cosmoz-input .value=${"a"} pattern="[2]"></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const n=o.querySelector("cosmoz-input");await t("validate returns false for invalid pattern",async()=>{a(n.validate()).toBe(!1)})}},p={render:()=>s`
        ${c}
        <cosmoz-input allowed-pattern="[c]"></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const e=o.querySelector("cosmoz-input").shadowRoot.querySelector("input");await t("allowed character is not prevented",async()=>{a(e.dispatchEvent(new InputEvent("beforeinput",{data:"c",cancelable:!0}))).toBe(!0)}),await t("disallowed character is prevented",async()=>{a(e.dispatchEvent(new InputEvent("beforeinput",{data:"2",cancelable:!0}))).toBe(!1)})}},i={render:()=>s`
        ${c}
        <cosmoz-input></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const n=o.querySelector("cosmoz-input");await t("input event triggers value-changed",async()=>{const e=v();n.addEventListener("value-changed",e,{once:!0}),a(e).not.toHaveBeenCalled(),n.shadowRoot.querySelector("input").dispatchEvent(new Event("input",{bubbles:!0})),a(e).toHaveBeenCalledTimes(1)})}},d={render:()=>s`
        ${c}
        <cosmoz-input placeholder="Search..."></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const n=o.querySelector("cosmoz-input");await t("placeholder attribute is forwarded to inner input",async()=>{const e=n.shadowRoot.querySelector("input");a(e.placeholder).toBe("Search...")})}},m={render:()=>s`
        ${c}
        <cosmoz-input><span slot="suffix">suffix</span></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const n=o.querySelector("cosmoz-input");await t("mousedown on suffix focuses input without blur",async()=>{const e=v();n.addEventListener("focused-changed",e,{once:!0}),a(e).not.toHaveBeenCalled(),n.shadowRoot.querySelector("input").dispatchEvent(new MouseEvent("mousedown",{bubbles:!0})),a(e).not.toHaveBeenCalled(),n.querySelector("span").dispatchEvent(new MouseEvent("mousedown",{bubbles:!0})),await h(()=>{a(e).toHaveBeenCalledTimes(1)}),n.querySelector("span").dispatchEvent(new MouseEvent("mousedown",{bubbles:!0})),a(e).toHaveBeenCalledTimes(1)})}},y={render:()=>s`
        ${c}
        <cosmoz-input></cosmoz-input>
    `,play:async({canvasElement:o,step:t})=>{const n=o.querySelector("cosmoz-input");await t("host.focus() delegates to inner input via delegatesFocus",async()=>{n.focus(),await h(()=>{const e=n.shadowRoot.querySelector("input");a(n.shadowRoot.activeElement).toBe(e)})})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => html\`
        \${style}
        <cosmoz-input></cosmoz-input>
    \`,
...
}`,...y.parameters?.docs?.source}}};const q=["Focus","Change","Validate","AllowedPattern","ValueChanged","Placeholder","Mousedown","DelegatesFocus"];export{p as AllowedPattern,u as Change,y as DelegatesFocus,r as Focus,m as Mousedown,d as Placeholder,l as Validate,i as ValueChanged,q as __namedExportsOrder,b as default};
