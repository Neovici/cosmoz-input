import{g as h,b as x,a as y,l as v}from"./style-DfVSaA6O.js";import{b as I}from"./iframe-PmtfQVGR.js";import{b as w,s as R,r as z,c as A,o as n}from"./use-notify-property-4R8-UX0a.js";import{u as E}from"./use-input-Bjsj_WRC.js";import{g as F}from"./util-hjyn66mY.js";const P=e=>h(()=>{if(e==null)return;const a=new RegExp(e,"u");return t=>{!t.defaultPrevented&&t.data&&!a.test(t.data)&&t.preventDefault()}},[e]),S=["type","pattern","allowed-pattern","min","max","step","autosize","label","placeholder",...w],B=e=>{const{type:a="text",pattern:t,allowedPattern:p,autocomplete:u,value:o,readonly:l,disabled:r,min:i,max:m,step:d,maxlength:c}=e,{onChange:$,onFocus:s,onInput:f,onRef:b}=E(e),g=P(p);return z(I`
			<input
				${A(b)}
