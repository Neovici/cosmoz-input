import{c as n,a as g,u as d,l as p,n as i}from"./style-CNldG1nu.js";import{b as o}from"./iframe-DNUXmUON.js";const b=t=>{const{label:l,value:s,disabled:a,error:r}=t,c=d(e=>t.dispatchEvent(new CustomEvent("change",{detail:e.target.checked})),[]);return o`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
