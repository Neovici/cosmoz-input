import{f as n,c as g,d,l as p,n as i}from"./style-CO_r6297.js";import{b as o}from"./iframe-C3ar23qj.js";const b=t=>{const{label:l,value:s,disabled:a,error:r}=t,c=d(e=>t.dispatchEvent(new CustomEvent("change",{detail:e.target.checked})),[]);return o`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
