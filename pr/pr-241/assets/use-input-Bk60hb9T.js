...
`,H=g(class extends y{values;constructor(o,t,e,a){super(o,t),Object.assign(t.host,e),this.values=a}update(o,t){this.hasChanged(t)&&(this.values=t,Object.assign(this.state.host,o))}hasChanged(o=[]){return o.some((t,e)=>this.values[e]!==t)}});g(class extends y{update(){return this.state.host}});const P=/([A-Z])/gu,m=(o,t,e)=>{o[t]=e,o.dispatchEvent(new CustomEvent(t.replace(P,"-$1").toLowerCase()+"-changed",{detail:{value:e}}))},W=o=>{const t=M(void 0),e=n(s=>t.current=s,[]),a=o.shadowRoot,l=n(s=>o.dispatchEvent(new Event(s.type,{bubbles:s.bubbles})),[]),i=n(s=>m(o,"value",s.target.value),[]),x=n(s=>m(o,"focused",s.type==="focus"),[]),u=n(()=>{const s=t.current?.checkValidity();return o.toggleAttribute("invalid",!s),s},[]);return H({validate:u},[u]),G(()=>{const s=f=>{f.composedPath()[0]?.closest?.("input, textarea")||(f.preventDefault(),t.current?.focus())};return a.addEventListener("mousedown",s),()=>a.removeEventListener("mousedown",s)},[]),{onChange:l,onFocus:x,onInput:i,onRef:e}};export{U as a,D as n,j as o,S as r,V as s,W as u};
