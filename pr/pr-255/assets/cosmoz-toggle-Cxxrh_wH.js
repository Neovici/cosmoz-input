import{n as e}from"./chunk-zsgVPwQN.js";import{s as t}from"./iframe-C33fZPbn.js";import{_ as n,h as r,i,n as a,r as o,t as s,u as c,v as l}from"./live-2-MjrS5d.js";var u,d,f,p=e((()=>{o(),s(),n(),u=e=>{let{label:n,value:r,disabled:i,error:o}=e,s=c(t=>e.dispatchEvent(new CustomEvent(`change`,{detail:t.target.checked})),[]);return t`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
...
`,customElements.define(`cosmoz-toggle`,i(u,{styleSheets:[f,d],observedAttributes:[`label`,`disabled`,`error`]}))}));export{p as t};