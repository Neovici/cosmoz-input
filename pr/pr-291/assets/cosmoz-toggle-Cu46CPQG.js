import{n as e}from"./chunk-zsgVPwQN.js";import{s as t}from"./iframe-DlKnsLkN.js";import{d as n,g as r,i,n as a,r as o,t as s,v as c,y as l}from"./live-A4SGqJhn.js";var u,d,f,p=e((()=>{o(),s(),c(),u=e=>{let{label:r,value:i,disabled:o,error:s}=e,c=n(t=>e.dispatchEvent(new CustomEvent(`change`,{detail:t.target.checked})),[]);return t`<input
			id="toggle"
			class="toggle"
			part="toggle"
			type="checkbox"
			...
			@change=${c}
		/>
		${l(r,()=>t`<label for="toggle">${r}</label>`)}
		<slot name="suffix"></slot>
		${l(s,e=>t`<div class="failure">${e}</div>`)} `},d=r`
	.toggle {
		appearance: none;
