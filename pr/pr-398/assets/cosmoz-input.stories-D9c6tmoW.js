import{i as e}from"./preload-helper-CCSz8wUY.js";import{l as t,u as n}from"./iframe-CFy_mvqk.js";import{d as r,p as i}from"./use-input-DmLQd2Fz.js";import{t as a}from"./cosmoz-input-CkUguBrU.js";var o,s,c,l,u,d,f,p,m,h,g;e((()=>{r(),n(),a(),o={title:`Components/Cosmoz Input`,component:`cosmoz-input`,tags:[`autodocs`],argTypes:{label:{control:`text`,description:`Label text displayed above the input`},placeholder:{control:`text`,description:`Placeholder text`},value:{control:`text`,description:`Input value`},type:{control:`select`,options:[`text`,`number`,`password`,`email`,`color`],description:`Native input type`,table:{defaultValue:{summary:`text`}}},variant:{control:`select`,options:[`inline`,`cell`],description:`Visual variant`,table:{defaultValue:{summary:`—`}}},compact:{control:`boolean`,description:`Hides label/hint/error text; shows tooltip icon instead`,table:{defaultValue:{summary:`false`}}},required:{control:`boolean`,description:`Marks field as required, shows * on label`,table:{defaultValue:{summary:`false`}}},invalid:{control:`boolean`,description:`Toggles error state (red border, error message)`,table:{defaultValue:{summary:`false`}}},errorMessage:{control:`text`,description:`Error text shown below input (or in tooltip when compact)`},hint:{control:`text`,description:`Helper text below input (hidden when invalid)`},disabled:{control:`boolean`,description:`Disables input, reduces opacity, not-allowed cursor`,table:{defaultValue:{summary:`false`}}},readonly:{control:`boolean`,description:`Makes input read-only`,table:{defaultValue:{summary:`false`}}},autosize:{control:`boolean`,description:`Input width adjusts to content length`,table:{defaultValue:{summary:`false`}}}}},s=e=>t`
    <cosmoz-input
        ...
        ?autosize=${e.autosize}
    ></cosmoz-input>
`,c={args:{label:`Email`,placeholder:`olivia@untitledui.com`,hint:`This is a hint text to help user.`,required:!1,invalid:!1,disabled:!1,compact:!1,type:`text`},render:s,parameters:{docs:{description:{story:`Interactive playground — use the controls to explore all props.`}}}},l={render:()=>t`
    ...
    `,parameters:{docs:{description:{story:`The default variant with bordered wrap, label above, and hint/error text below.`}}}},u={render:()=>t`
        <div class="story-stack">
    ...
    `,parameters:{docs:{description:{story:`Floating label that translates up on focus or when the input has a value. No border, no hint/error text, no tooltip icon.`}}}},d={render:()=>t`
        <div class="story-stack">
    ...
    `,parameters:{docs:{description:{story:`Minimal input for table/grid contexts. No label, thin border, no border-radius. Background highlights on focus.`}}}},f={render:()=>t`
        <div class="story-stack">
    ...
    `,parameters:{docs:{description:{story:`Compact mode hides label, hint, and error text. A tooltip icon is always visible: help icon when valid, red info icon when invalid.`}}}},p={render:()=>{let e=/^[^\s@]+@[^\s@]+\.[^\s@]+$/u,n=t=>{let n=t.target,r=!n.value||e.test(n.value);n.toggleAttribute(`invalid`,!r),r?n.errorMessage=void 0:n.errorMessage=`Please enter a valid email`};return t`
            <div class="story-stack">
        ...
        `},parameters:{docs:{description:{story:`Real-time email validation using toggleAttribute and errorMessage. Shows how to implement external validation logic.`}}}},m={render:()=>{let e=i({slot:`prefix`,width:`20`,height:`20`}),n=i({slot:`suffix`,width:`20`,height:`20`});return t`
            <div class="story-stack">
        ...
        `},parameters:{docs:{description:{story:`Prefix and suffix slots accept any slotted content (icons, text). Shown across all variants.`}}}},h={render:()=>t`
        <div class="story-stack">
    ...
    `,parameters:{docs:{description:{story:`Input width adjusts to content length. Works with number inputs with or without spinner.`}}}},g=[`Playground`,`Default`,`Inline`,`Cell`,`Compact`,`LiveValidation`,`PrefixAndSuffix`,`Autosize`],c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Email',
    placeholder: 'olivia@untitledui.com',
    hint: 'This is a hint text to help user.',
...
}`,...h.parameters?.docs?.source}}}}))();export{h as Autosize,d as Cell,f as Compact,l as Default,u as Inline,p as LiveValidation,c as Playground,m as PrefixAndSuffix,g as __namedExportsOrder,o as default};