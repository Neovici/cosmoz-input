import{i as e}from"./preload-helper-CCSz8wUY.js";import{l as t,u as n}from"./iframe-CFy_mvqk.js";import{n as r,t as i}from"./style-BHYM1NT7.js";import{t as a}from"./cosmoz-toggle-CvTRIDVV.js";var o,s,c,l,u,d,f;e((()=>{n(),a(),i(),{expect:o,waitFor:s}=__STORYBOOK_MODULE_TEST__,c={title:`Components/Toggle`,component:`cosmoz-toggle`,tags:[`autodocs`]},l={render:()=>t`
        ${r}
    ...
    `,play:async({canvasElement:e,step:t})=>{let n=e.querySelector(`cosmoz-toggle`);await t(`checkbox is disabled`,async()=>{let e=n.shadowRoot.querySelector(`input`);o(e.disabled).toBe(!0)})}},d={render:()=>t`
        ${r}
        <cosmoz-toggle
            .label=${`Is active`}
